...
import com.justino.cursomc.domain.Estado;
...
import com.justino.cursomc.domain.PagamentoComCartao;
...
import com.justino.cursomc.domain.enums.Perfil;
...
import com.justino.cursomc.repositories.EstadoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "antonio.command@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "antoniojustino@live.com", "96311143097", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("32313123", "93838355"));
